...
public class AutoVisionShootBlue extends Command {    
    private double ty;
    private double ta;
    ...
    public AutoVisionShootBlue(Swerve s_Swerve) {
    ...
    public void execute() {
        ...
        yShooterAngle = (-0.0104986*ty*ty) + (0.80866*ty) + (19.2) + shooterAddValue; // 18.8 v2-17
