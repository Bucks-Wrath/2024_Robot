...
public class VisionAlignShoot extends Command {    
    ...
    public void execute() {
        ...
        aShooterAngle = (-7.3996*ta*ta) + (34.3482*ta) - 0.75 + shooterAddValue; // - 1.38093  was -0.5

        // use ty to calculate shooter angle
        // Eggo (-0.009811884*ty*ty) + (0.740631*ty) + (17);  // 18.3463
        yShooterAngle = (-0.00280493*ty*ty) + (0.986053*ty) + (21) + shooterAddValue;  // 21.3444 was 22.5
