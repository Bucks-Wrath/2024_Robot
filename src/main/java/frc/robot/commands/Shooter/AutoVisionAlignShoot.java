...
public class AutoVisionAlignShoot extends Command {    
    ...
    public void execute() {
        ...
        aShooterAngle = (-7.3996*ta*ta) + (34.3482*ta) - 1.25 + shooterAddValue; // - 1.38093  was -0.5
        ...
        shooterAngle = ((aShooterAngle + aShooterAngle) / 2) - xSpeed;  // is this going the right way and is it the right value
